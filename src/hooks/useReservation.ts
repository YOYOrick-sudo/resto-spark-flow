  ...
  return useQuery<Reservation | null>({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          customers:customer_id (id, first_name, last_name, email, phone_number, language, tags, notes, total_visits, total_no_shows, total_cancellations, first_visit_at, last_visit_at, dietary_preferences),
