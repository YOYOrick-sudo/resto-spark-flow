...
function UnassignedGridRow({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="border-b border-warning/30 bg-warning/12">
        {/* Row: sticky label + timeline */}
        <div className={cn("flex", isCompact ? "h-9" : "h-12")}>
          {/* Sticky left column */}
          <div
            className="sticky left-0 z-30 flex-shrink-0 flex items-center gap-1.5 px-3 border-r-2 border-border bg-warning/12"
