...
function SeatedCountRow({
  ...
  return (
    <div className="flex h-8 border-b-2 border-border bg-secondary sticky top-[40px] z-[60]">
...
function ZoneHeader({ name, isCompact = false }: { name: string; isCompact?: boolean }) {
  return (
    <div className={cn("flex bg-secondary border-b border-t border-border", isCompact ? "h-7" : "h-8")}>
      <div className="sticky left-0 z-[60] flex-shrink-0 bg-secondary border-r-2 border-border flex items-center px-3" style={{ width: `${STICKY_COL_WIDTH}px` }}>
...
function UnassignedGridRow({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="sticky top-[72px] z-[60] border-b-2 border-border">
