...
export function LogoUploadField({ logoUrl }: LogoUploadFieldProps) {
    ...
    return (
      <div>
        ...
        <ConfirmDialog
          ...
          title="Logo verwijderen"
          description="Weet je zeker dat je het logo wilt verwijderen? Het wordt niet meer getoond in uitgaande emails."
  ...
  return (
    <div>
      ...
      <p className="text-xs text-muted-foreground mt-1">
        PNG, JPG of SVG. Max 2 MB. Verschijnt bovenaan elke email.
      </p>
