  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        {/* Card 2: Weergave */}
        <NestoCard className="p-6">
          <SettingsCardHeader title="Weergave" description="Bepaal wat gasten zien in de widget." helpText={buildHelp("Bepaal de visuele stijl en branding-opties die gasten zien.")} />
        ...
        {/* Card 3: Branding */}
        <NestoCard className="p-6">
          <SettingsCardHeader title="Branding" description="Kleuren en logo van de widget." helpText={buildHelp("Pas kleuren en logo aan om de widget bij je huisstijl te laten passen.")} />
        ...
        <NestoCard className="p-6">
          <SettingsCardHeader title="Boekingsvragen" description="Extra vragen die gasten zien bij het boeken. Antwoorden worden opgeslagen als tags." helpText={buildHelp("Stel extra vragen in die gasten beantwoorden bij het boeken. Antwoorden worden als tags opgeslagen.")} />
        ...
        {local.widget_enabled && local.location_slug && (
          <NestoCard className="p-6">
            <SettingsCardHeader title="Integratie" description="Kies hoe je de widget op je website wilt tonen." helpText={buildHelp("Embed de widget op je website via een knop, inline container of directe link.")} />
