    ...
    fetch(CONFIG_URL).then(function(r){return r.json()}).then(function(cfg){
      ...
      styles.textContent=\`
        *{box-sizing:border-box;margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;}
        ...
        .nesto-bar{position:fixed;left:0;right:0;z-index:999997;padding:14px 48px 14px 24px;display:flex;align-items:center;justify-content:center;gap:12px;transform:translateY(100%);transition:transform .3s ease;}
