...
BEGIN
  ...
  -- FIX 1: type 'checkbox' -> 'check' (validate_checklist_response_type trigger accepts only check/temperatuur/notitie/foto)
  ...
  ELSIF _temp_skip ? 'gekoeld' THEN
    -- FIX 2: skipped temp logged as 'notitie' (matches the actual data shape: text in notitie field)
